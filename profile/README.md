...
The original dictated version and alternate edits are preserved in [`docs/change/`](../docs/change/).
...
1. Building Schrödinger’s Inbox
2. Developing a manageable home-lab AI platform
3. Creating repeatable agentic development workflows
4. Modernizing Utah Hockey’s technical infrastructure
5. Publishing useful scripts, documentation, and deployment patterns
6. Turning several years of scattered ideas into functioning products
7. Avoiding the creation of any new “quick side projects” until at least three existing ones become self-supporting
...
### I build systems that work, document what I learn, and automate the parts no one should have to do twice.
